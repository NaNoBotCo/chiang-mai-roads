...
from harvest_osm import overpass  # noqa: E402

# The map box: the city, Doi Suthep to the west and the plain to the east.  S, W, N, E
BBOX = (18.62, 98.80, 18.96, 99.12)
